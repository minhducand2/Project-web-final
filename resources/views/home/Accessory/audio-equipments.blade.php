                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="{{route('product-details')}}" class="ht-product-image">
                                                        <img src="home/img/product/product-1.png"
                                                             alt="Universal Product Style"> </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li><a href="#" data-toggle="modal" data-target="#Shop"><i
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                        ...
                                                        <h4 class="ht-product-title"><a
                                                                href="{{route('product-details')}}">laptop Zenbook</a>
                                                        </h4>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="{{route('product-details')}}" class="ht-product-image">
                                                        <img src="home/img/product/product-2.png"
                                                             alt="Universal Product Style"> </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li><a href="#" data-toggle="modal" data-target="#Shop"><i
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                        ...
                                                        <h4 class="ht-product-title"><a
                                                                href="{{route('product-details')}}">IPhone13</a></h4>
                                                        <div class="ht-product-price">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="{{route('product-details')}}" class="ht-product-image">
                                                        <img src="home/img/product/product-3.png"
                                                             alt="Universal Product Style"> </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li><a href="#" data-toggle="modal" data-target="#Shop"><i
                                    ...
                                    <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="{{route('product-details')}}" class="ht-product-image">
                                                        <img src="home/img/product/product-4.png"
                                                             alt="Universal Product Style"> </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li><a href="#" data-toggle="modal" data-target="#Shop"><i
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                        ...
                                                        <h4 class="ht-product-title"><a
                                                                href="{{route('product-details')}}">Sony MDR-ZX310AP</a>
                                                        </h4>
                                                        <div class="ht-product-price">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="{{route('product-details')}}" class="ht-product-image">
                                                        <img src="home/img/product/product-5.png"
                                                             alt="Universal Product Style"> </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li><a href="#" data-toggle="modal" data-target="#Shop"><i
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                        <div class="ht-product-categories"><a href="#">Clock</a></div>
                                                        <h4 class="ht-product-title"><a href="#">FLOVEME VZV 23M</a>
                                                        </h4>
                                                        <div class="ht-product-price">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="{{route('product-details')}}" class="ht-product-image">
                                                        <img src="home/img/product/product-6.png"
                                                             alt="Universal Product Style"> </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li><a href="#" data-toggle="modal" data-target="#Shop"><i
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                        <div class="ht-product-categories"><a href="#">Lamp </a></div>
                                                        <h4 class="ht-product-title"><a href="#">Usb bluetooth 5.0</a>
                                                        </h4>
                                                        <div class="ht-product-price">
                                                            <span class="new">$50.00</span>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="{{route('product-details')}}" class="ht-product-image">
                                                        <img src="home/img/product/product-7.png"
                                                             alt="Universal Product Style"> </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li><a href="#" data-toggle="modal" data-target="#Shop"><i
                                    ...
                                    <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="{{route('product-details')}}" class="ht-product-image">
                                                        <img src="home/img/product/product-8.png"
                                                             alt="Universal Product Style"> </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li><a href="#" data-toggle="modal" data-target="#Shop"><i
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                        <div class="ht-product-categories"><a href="#">Chair</a></div>
                                                        <h4 class="ht-product-title"><a href="#">SSD 128GB</a></h4>
                                                        <div class="ht-product-price">
                                                            <span class="new">$60.00</span>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-lg-6 col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <div class="ht-product-inner">
                                                <div class="ht-product-image-wrap">
                                                    <a href="{{route('product-details')}}" class="ht-product-image">
                                                        <img src="home/img/product/product-8-1.png"
                                                             alt="Universal Product Style"> </a>
                                                    <div class="ht-product-action">
                                                        <ul>
                                                            <li><a href="#" data-toggle="modal" data-target="#Shop"><i
                                                ...
                                                <div class="ht-product-content">
                                                    <div class="ht-product-content-inner">
                                                        <div class="ht-product-categories"><a href="#">Lamp </a></div>
                                                        <h4 class="ht-product-title"><a href="#">Wifi TP-Link Archer
                                                                C54</a></h4>
                                                        <div class="ht-product-price">
                                                            <span class="new">$50.00</span>
                                                            <span class="old">$80.00</span>
                                        ...
                                        <div class="col-lg-4 col-md-4">
                                            <div class="product-list-img">
                                                <a href="{{route('product-details')}}">
                                                    <img src="home/img/product/product-list-1.png"
                                                         alt="Universal Product Style">
                                                </a>
                                                <div class="product-quickview">
                                                    <a href="#" title="Quick View" data-toggle="modal"
                                                       data-target="#Shop"><i class="sli sli-magnifier-add"></i></a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-8 col-md-8 align-self-center">
                                            <div class="shop-list-content">
                                                <h3><a href="{{route('product-details')}}">Zenbook</a></h3>
                                ...
                                <div class="shop-list-wrap shop-list-mrg2 shop-list-mrg-none mb-30">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                            <div class="product-list-img">
                                                <a href="{{route('product-details')}}">
                                                    <img src="home/img/product/product-list-2.png"
                                                         alt="Universal Product Style">
                                                </a>
                                                <div class="product-quickview">
                                                    <a href="#" title="Quick View" data-toggle="modal"
                                        ...
                                        <div class="col-lg-8 col-md-8 align-self-center">
                                            <div class="shop-list-content">
                                                <h3><a href="{{route('product-details')}}">Iphone 13</a></h3>
                                                <p>It has roots in a piece of classical Latin literature from 45 BC,
                                                    making it over 2000 years old. Richard The standard chunk.</p>
                                                <span>Chair</span>
                                                <div class="shop-list-price-action-wrap">
                                ...
                                <div class="shop-list-wrap shop-list-mrg2 shop-list-mrg-none mb-30">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                            <div class="product-list-img">
                                                <a href="{{route('product-details')}}">
                                                    <img src="home/img/product/product-list-3.png"
                                                         alt="Universal Product Style">
                                                </a>
                                                <div class="product-quickview">
                                                    <a href="#" title="Quick View" data-toggle="modal"
                                        ...
                                        <div class="col-lg-8 col-md-8 align-self-center">
                                            <div class="shop-list-content">
                                                <h3><a href="{{route('product-details')}}">Macbook</a></h3>
                                                <p>It has roots in a piece of classical Latin literature from 45 BC,
                                                    making it over 2000 years old. Richard The standard chunk.</p>
                                                <span>Chair</span>
                                                <div class="shop-list-price-action-wrap">
                                ...
                                <div class="shop-list-wrap shop-list-mrg2 shop-list-mrg-none mb-30">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4">
                                            <div class="product-list-img">
                                                <a href="{{route('product-details')}}">
                                                    <img src="home/img/product/product-list-4.png"
                                                         alt="Universal Product Style">
                                                </a>
                                                <div class="product-quickview">
                                                    <a href="#" title="Quick View" data-toggle="modal"
