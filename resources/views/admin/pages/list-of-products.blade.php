...
@section('content')
                        ...
                        <td>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <img alt="Avatar" class="ht-product-image"
                                         src="{{asset('home/img/product/quickview-S3.png')}}">
                                </li>
                            </ul>
                        </td>
                        <td class="project-actions text-right">
                            <a class="btn btn-info btn-sm" href="{{route('create-products')}}">
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <img alt="Avatar" class="ht-product-image"
                                         src="{{asset('home/img/product/product-3.png')}}">
                                </li>
                            </ul>
                        </td>
                        <td class="project-actions text-right">
                            ...
                            <a class="btn btn-danger btn-sm" href="{{route('create-products')}}">
                                <i class="fas fa-trash">
                                </i>
                                Delete
                            </a>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Mobile Phone</h3>
                    ...
                    <tr>
                        ...
                        <td>
                            <ul class="list-inline">
                                <li class="list-inline-item">
                                    <img alt="Avatar" class="ht-product-image"
                                         src="{{asset('home/img/product/quickview-S1.png')}}">
                                </li>
                            </ul>
                        </td>
                        <td class="project-actions text-right">
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Fashion Shopping</h3>
